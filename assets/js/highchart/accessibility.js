...
*/
(function (a) {
	"object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/accessibility", ["highcharts"], function (p) {
		a(p);
		a.Highcharts = p;
		return a
	...
	function p(a, h, n, m) {
		a.hasOwnProperty(h) || (a[h] = m.apply(null, n))
	}
	a = a ? a._modules : {};
	p(a, "modules/accessibility/utils/htmlUtilities.js", [a["parts/Globals.js"]], function (a) {
		function l(a) {
		...
		return {
			addClass: function (a, e) {
				a.classList ? a.classList.add(e) : 0 > a.className.indexOf(e) && (a.className += e)
			},
			escapeStringForHTML: l,
			getElement: function (a) {
				return e.getElementById(a)
			},
			getFakeMouseEvent: function (a) {
				if ("function" === typeof m.MouseEvent) return new m.MouseEvent(a);
				if (e.createEvent) {
					var k = e.createEvent("MouseEvent");
					if (k.initMouseEvent) return k.initMouseEvent(a,
			...
			reverseChildNodes: function (a) {
				for (var e = a.childNodes.length; e--;) a.appendChild(a.childNodes[e])
			},
			setElAttrs: function (a, e) {
				Object.keys(e).forEach(function (f) {
					var b = e[f];
					null === b ? a.removeAttribute(f) : (b = l("" + b), a.setAttribute(f, b))
				})
			},
	...
	p(a, "modules/accessibility/utils/chartUtilities.js", [a["modules/accessibility/utils/htmlUtilities.js"], a["parts/Globals.js"]], function (a, h) {
		function l(a) {
			if (a.points && a.points.length && a.points[0].graphic) return a.points[0].graphic.element
		}

		function m(a) {
			var b = l(a);
			return b && b.parentNode || a.graph && a.graph.element || a.group &&
				a.group.element
		}

		function e(a, b) {
			b.setAttribute("aria-hidden", !1);
			b !== a.renderTo && b.parentNode && (Array.prototype.forEach.call(b.parentNode.childNodes, function (c) {
		...
		return {
			...
			getPointFromXY: function (a, b, c) {
				for (var d = a.length, g; d--;)
					if (g = r(a[d].points || [], function (d) {
							return d.x === b && d.y === c
						})) return g
			},
			getSeriesFirstPointElement: l,
			getSeriesFromName: function (a, b) {
				return b ? (a.series || []).filter(function (c) {
					return c.name === b
				}) : a.series
			},
			getSeriesA11yElement: m,
			unhideChartElementFromAT: e,
		...
		l.prototype = {
			run: function (a) {
				var e = a.which || a.keyCode,
					...
					r = n(this.keyCodeMap, function (a) {
						return -1 < a[0].indexOf(e)
					});
				r ? l = r[1].call(this, e, a) : 9 === e ? l = this.response[a.shiftKey ? "prev" : "next"] :
					27 === e && (this.chart && this.chart.tooltip && this.chart.tooltip.hide(0), l = this.response.success);
				return l
			}
		};
		return l
	});
	p(a, "modules/accessibility/utils/EventProvider.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, h) {
		h = h.extend;
		var l = function () {
			this.eventRemovers = []
		};
		h(l.prototype, {
			addEvent: function () {
				var l = a.addEvent.apply(a, arguments);
				this.eventRemovers.push(l);
				return l
			},
	...
	p(a,
		"modules/accessibility/utils/DOMElementProvider.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]],
		function (a, h, n) {
			var l = a.win.document;
			a = h.extend;
			var e = n.removeElement;
			n = function () {
				this.elements = []
			};
			a(n.prototype, {
	...
	p(a, "modules/accessibility/AccessibilityComponent.js",
		[a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/EventProvider.js"], a["modules/accessibility/utils/DOMElementProvider.js"]],
		function (a, h, n, m, e, k) {
			...
			var f = a.win,
				...
				d = a.fireEvent;
			a = h.extend;
			var g = n.removeElement,
				t = n.getFakeMouseEvent,
				w = m.unhideChartElementFromAT;
			l.prototype = {
				initBase: function (a) {
					this.chart = a;
					this.eventProvider = new e;
				...
				fireEventOnWrappedOrUnwrappedElement: function (a, c) {
					var q = c.type;
					b.createEvent && (a.dispatchEvent || a.fireEvent) ? a.dispatchEvent ? a.dispatchEvent(c) : a.fireEvent(q, c) : d(a, q, c)
				},
				...
				createOrUpdateProxyContainer: function () {
					...
					c.nextSibling !== a.a11yProxyContainer && a.container.insertBefore(a.a11yProxyContainer,
						c.nextSibling)
				},
				...
				createProxyButton: function (a, d, g, b, t) {
					var q = a.element,
						u = this.createElement("button"),
						f = c({
							"aria-label": q.getAttribute("aria-label")
						}, g);
					a = this.getElementPosition(b || a);
					Object.keys(f).forEach(function (a) {
						null !== f[a] && u.setAttribute(a, f[a])
					});
					u.className = "highcharts-a11y-proxy-button";
					t && this.addEvent(u, "click", t);
					this.setProxyButtonStyle(u, a);
					this.proxyMouseEventsForButton(q,
						u);
					d.appendChild(u);
					f["aria-hidden"] || w(this.chart, u);
					return u
				},
				...
				setProxyButtonStyle: function (a, d) {
					c(!0, a.style, {
						"border-width": 0,
				...
				proxyMouseEventsForButton: function (a, c) {
					var d = this;
					"click touchstart touchend touchcancel touchmove mouseover mouseenter mouseleave mouseout".split(" ").forEach(function (q) {
						d.addEvent(c, q, function (c) {
							var q = d.cloneMouseEvent(c);
							a && d.fireEventOnWrappedOrUnwrappedElement(a, q);
							c.stopPropagation();
							c.preventDefault()
						})
					})
				...
				cloneMouseEvent: function (a) {
					if ("function" ===
						typeof f.MouseEvent) return new f.MouseEvent(a.type, a);
					if (b.createEvent) {
						var c = b.createEvent("MouseEvent");
						if (c.initMouseEvent) return c.initMouseEvent(a.type, a.bubbles, a.cancelable, a.view || f, a.detail, a.screenX, a.screenY, a.clientX, a.clientY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, a.button, a.relatedTarget), c
					}
					return t(a.type)
				},
	...
	p(a, "modules/accessibility/KeyboardNavigation.js", [a["parts/Globals.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/EventProvider.js"]], function (a, h, n, m) {
		...
		e.prototype = {
			init: function (a, d) {
				...
				b.addEvent(a.renderTo, "keydown", function (a) {
					c.onKeydown(a)
				});
				b.addEvent(f, "mouseup", function () {
					c.onMouseUp()
				});
				this.update();
			...
			onMouseUp: function () {
				if (!(this.keyboardReset || this.chart.pointer && this.chart.pointer.chartPosition)) {
					var a = this.chart,
						d = this.modules && this.modules[this.currentModuleIx || 0];
			...
			onKeydown: function (a) {
				...
				if (b) {
					var f = b.run(a);
					f === b.response.success ? c = !0 : f === b.response.prev ? c = this.prev() : f === b.response.next && (c = this.next());
			...
			updateExitAnchor: function () {
				var a = b("highcharts-end-of-chart-marker-" + this.chart.index);
			...
			updateContainerTabindex: function () {
				...
				var d = this.chart.container,
					b = d.getAttribute("tabIndex");
				a && !b ? d.setAttribute("tabindex", "0") : a || "0" !== b || d.removeAttribute("tabindex")
			},
			...
			createExitAnchor: function () {
				var a = this.chart,
					d = this.exitAnchor = f.createElement("div");
				l(!0, d.style, {
					position: "absolute",
					width: "1px",
					height: "1px",
			...
			addExitAnchorEventsToEl: function (a) {
				...
				this.eventProvider.addEvent(a, "focus", function (a) {
					a = a || r.event;
					a.relatedTarget && c.container.contains(a.relatedTarget) || b.exiting ? b.exiting = !1 : (c.renderTo.focus(), a.preventDefault(), b.modules && b.modules.length && (b.currentModuleIx = b.modules.length - 1, (a = b.modules[b.currentModuleIx]) &&
			...
			destroy: function () {
				this.removeExitAnchor();
				this.eventProvider.removeAddedEvents();
				"0" === this.chart.container.getAttribute("tabindex") && this.chart.container.removeAttribute("tabindex")
			}
		};
		return e
	});
	p(a, "modules/accessibility/components/LegendComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/htmlUtilities.js"]],
		function (a, h, n, m, e) {
			h = h.extend;
			var l = e.stripHTMLTagsFromString,
				r = e.removeElement;
			a.Chart.prototype.highlightLegendItem = function (f) {
				var b = this.legend.allItems,
					c = this.highlightedLegendItemIx;
				if (b[f]) {
					b[c] && a.fireEvent(b[c].legendGroup.element, "mouseout");
					c = this.legend;
					var d = c.allItems[f].pageIx,
						g = c.currentPage;
					"undefined" !== typeof d && d + 1 !== g && c.scroll(1 + d - g);
					this.setFocusToElement(b[f].legendItem, b[f].a11yProxyElement);
					a.fireEvent(b[f].legendGroup.element, "mouseover");
					return !0
				}
				return !1
			};
			a.addEvent(a.Legend,
				...
				function (a) {
					var b = a.item;
					this.chart.options.accessibility.enabled && b && b.a11yProxyElement && b.a11yProxyElement.setAttribute("aria-pressed", a.visible ? "false" : "true")
				});
			e = function () {};
			e.prototype = new n;
			h(e.prototype, {
				init: function () {
					var f = this;
					this.addEvent(a.Legend, "afterScroll", function () {
						this.chart === f.chart && f.updateProxies()
					})
				},
				updateLegendItemProxyVisibility: function () {
					var a = this.chart.legend,
						b = a.currentPage || 1;
					(a.allItems || []).forEach(function (a) {
						var c = (a.pageIx || 0) !== b - 1;
						a.a11yProxyElement &&
							(a.a11yProxyElement.style.visibility = c ? "hidden" : "visible")
					})
				},
				onChartRender: function () {
					this.legendProxyButtonClicked ? delete this.legendProxyButtonClicked : this.updateProxies()
				},
				updateProxies: function () {
					r(this.legendProxyGroup);
					var a = this.chart,
						b = a.legend && a.legend.allItems,
						c = a.options.legend.accessibility || {};
					!b || !b.length || a.colorAxis && a.colorAxis.length || !1 === c.enabled || (this.addLegendProxyGroup(), this.proxyLegendItems(), this.updateLegendItemProxyVisibility())
				},
				addLegendProxyGroup: function () {
					var a =
						this.chart.options.accessibility,
						b = this.chart.langFormat("accessibility.legend.legendLabel", {});
				...
				proxyLegendItem: function (a) {
					var b = this,
						c = this.chart.langFormat("accessibility.legend.legendItem", {
							chart: this.chart,
							itemName: l(a.name)
						});
					a.a11yProxyElement = this.createProxyButton(a.legendItem, this.legendProxyGroup, {
						tabindex: -1,
						"aria-pressed": !a.visible,
						"aria-label": c
					}, a.legendGroup.div ? a.legendItem : a.legendGroup, function () {
						b.legendProxyButtonClicked = !0
					})
				},
				getKeyboardNavigation: function () {
					var a = this.keyCodes,
						b = this;
					return new m(this.chart, {
						keyCodeMap: [
							[
				...
				onKbdArrowKey: function (a, b) {
					var c = this.keyCodes,
						d = a.response,
						g = this.chart,
						e = g.options.accessibility,
						f = g.legend.allItems.length;
					b = b === c.left || b === c.up ? -1 : 1;
					return g.highlightLegendItem(this.highlightedLegendItemIx + b) ? (this.highlightedLegendItemIx += b, d.success) : 1 < f && e.keyboardNavigation.wrapAround ? (a.init(b), d.success) : d[0 < b ? "next" : "prev"]
				},
				onKbdClick: function (e) {
					var b = this.chart.legend.allItems[this.highlightedLegendItemIx];
					b && b.a11yProxyElement &&
						a.fireEvent(b.a11yProxyElement, "click");
	...
	p(a, "modules/accessibility/components/MenuComponent.js",
		[a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]],
		function (a, h, n, m, e, k) {
			h = h.extend;
			var l = e.unhideChartElementFromAT,
				f = k.removeElement,
				b = k.getFakeMouseEvent;
			...
			a.Chart.prototype.hideExportMenu = function () {
				...
				a && this.exportContextMenu && (a.forEach(function (a) {
					if ("highcharts-menu-item" === a.className && a.onmouseout) a.onmouseout(b("mouseout"))
			...
			a.Chart.prototype.highlightExportItem = function (a) {
				var c = this.exportDivElements && this.exportDivElements[a],
					g = this.exportDivElements && this.exportDivElements[this.highlightedExportItemIx];
				if (c && "LI" === c.tagName && (!c.children || !c.children.length)) {
					var e = !!(this.renderTo.getElementsByTagName("g")[0] || {}).focus;
					c.focus && e && c.focus();
					if (g && g.onmouseout) g.onmouseout(b("mouseout"));
					if (c.onmouseover) c.onmouseover(b("mouseover"));
			...
			a.Chart.prototype.highlightLastExportItem = function () {
				...
				if (this.exportDivElements)
					for (a = this.exportDivElements.length; a--;)
			...
			h(a.prototype, {
				...
				onMenuShown: function () {
					var a = this.chart,
						d = a.exportContextMenu;
					d && (this.addAccessibleContextMenuAttribs(), l(a, d));
				...
				onChartRender: function () {
					...
					f(this.exportProxyGroup);
					var b = a.options.exporting;
					b && !1 !== b.enabled && b.accessibility && b.accessibility.enabled && a.exportSVGElements && a.exportSVGElements[0] && a.exportSVGElements[0].element && (this.exportProxyGroup = this.addProxyGroup("all" === d.landmarkVerbosity ? {
							"aria-label": a.langFormat("accessibility.exporting.exportRegionLabel", {
								chart: a
							}),
							role: "region"
						} : {}), this.exportButtonProxy =
						this.createProxyButton(this.chart.exportSVGElements[0], this.exportProxyGroup, {
				...
				addAccessibleContextMenuAttribs: function () {
					...
					}), b = b[0].parentNode, b.removeAttribute("aria-hidden"), b.setAttribute("aria-label", a.langFormat("accessibility.exporting.chartMenuLabel", {
						chart: a
					})))
				},
				getKeyboardNavigation: function () {
				...
				onKbdPrevious: function (a) {
					...
					a = a.response;
					for (var e = b.highlightedExportItemIx || 0; e--;)
						if (b.highlightExportItem(e)) return a.success;
					return c.keyboardNavigation.wrapAround ? (b.highlightLastExportItem(), a.success) : a.prev
				},
				onKbdNext: function (a) {
					var b = this.chart,
						c = b.options.accessibility;
					a = a.response;
					for (var e = (b.highlightedExportItemIx || 0) + 1; e < b.exportDivElements.length; ++e)
						if (b.highlightExportItem(e)) return a.success;
					return c.keyboardNavigation.wrapAround ? (b.highlightExportItem(0), a.success) : a.next
				},
				onKbdClick: function (a) {
					var b = this.chart;
					this.fakeClickEvent(b.exportDivElements[b.highlightedExportItemIx]);
		...
		function (a, h, n, m, e) {
			...
			function b(a, b, c, d) {
				...
				if (!e(a)) {
					for (; u--;) {
						var g = b.points[u];
						if (!e(g) && (g = (a.plotX - g.plotX) * (a.plotX - g.plotX) * (c || 1) + (a.plotY - g.plotY) * (a.plotY - g.plotY) * (d || 1), g < q)) {
							q = g;
							var f = u
						}
					}
					return t(f) ? b.points[f] : void 0
				}
			}
			...
			var g = h.extend,
				t = h.defined,
				w = e.getPointFromXY,
				y = e.getSeriesFromName;
			a.Series.prototype.keyboardMoveVertical = !0;
			["column", "pie"].forEach(function (b) {
				a.seriesTypes[b] && (a.seriesTypes[b].prototype.keyboardMoveVertical = !1)
			});
			a.Point.prototype.highlight = function () {
			...
			a.Chart.prototype.highlightAdjacentPoint =
				function (a) {
					var b = this.series,
						c = this.highlightedPoint,
						d = c && k(c) || 0,
						v = c && c.series.points,
						e = this.series && this.series[this.series.length - 1];
					e = e && e.points && e.points[e.points.length - 1];
					if (!b[0] || !b[0].points) return !1;
					if (c) {
						if (b = b[c.series.index + (a ? 1 : -1)], d = v[d + (a ? 1 : -1)], !d && b && (d = b.points[a ? 0 : b.points.length - 1]), !d) return !1
					} else d = a ? b[0].points[0] : e;
					return f(d) ? (b = d.series, l(b) ? this.highlightedPoint = a ? b.points[b.points.length - 1] : b.points[0] : this.highlightedPoint = d, this.highlightAdjacentPoint(a)) : d.highlight()
				};
			a.Series.prototype.highlightFirstValidPoint = function () {
				...
				if (a && c) {
					for (var d = b; d < c; ++d)
						if (!f(a[d])) return a[d].highlight();
					for (; 0 <= b; --b)
						if (!f(a[b])) return a[b].highlight()
				}
				return !1
			};
			a.Chart.prototype.highlightAdjacentSeries = function (a) {
				var c, d = this.highlightedPoint;
				var e = (c = this.series && this.series[this.series.length - 1]) && c.points && c.points[c.points.length - 1];
				if (!this.highlightedPoint) return c = a ? this.series &&
					this.series[0] : c, (e = a ? c && c.points && c.points[0] : e) ? e.highlight() : !1;
				c = this.series[d.series.index + (a ? -1 : 1)];
				if (!c) return !1;
				e = b(d, c, 4);
				if (!e) return !1;
				if (l(c)) return e.highlight(), a = this.highlightAdjacentSeries(a), a ? a : (d.highlight(), !1);
				e.highlight();
				return e.series.highlightFirstValidPoint()
			};
			a.Chart.prototype.highlightAdjacentPointVertical = function (a) {
				...
				this.series.forEach(function (e) {
					l(e) || e.points.forEach(function (v) {
						if (t(v.plotY) &&
							t(v.plotX) && v !== b) {
							var g = v.plotY - b.plotY,
								q = Math.abs(v.plotX - b.plotX);
							q = Math.abs(g) * Math.abs(g) + q * q * 4;
							e.yAxis.reversed && (g *= -1);
							!(0 >= g && a || 0 <= g && !a || 5 > q || f(v)) && q < c && (c = q, d = v)
						}
					})
				});
			...
			g(d.prototype, {
				init: function () {
					var b = this,
						d = this.chart,
						e = this.eventProvider = new m;
					e.addEvent(a.Series, "destroy", function () {
						return b.onSeriesDestroy(this)
					});
					e.addEvent(d, "afterDrilldown", function () {
						c(this);
				...
				onDrillupAll: function () {
					var a = this.lastDrilledDownPoint,
						b = this.chart,
						c = a && y(b, a.seriesName),
						d;
					a && c && t(a.x) && t(a.y) && (d = w(c, a.x, a.y));
				...
				getKeyboardNavigationHandler: function () {
					...
					return new n(c, {
						keyCodeMap: [
							[d ? [b.up, b.down] : [b.left, b.right], function (b) {
								return a.onKbdSideways(this, b)
							}],
							[d ? [b.left, b.right] : [b.up, b.down], function (b) {
				...
				onKbdSideways: function (a, b) {
					var c = this.keyCodes;
					return this.attemptHighlightAdjacentPoint(a,
						b === c.right || b === c.down)
				},
				onKbdVertical: function (a, b) {
					var c = this.chart,
						d = this.keyCodes;
				...
				attemptHighlightAdjacentPoint: function (a, b) {
					var c = this.chart,
	...
	p(a, "modules/accessibility/components/SeriesComponent/SeriesDescriber.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"]], function (a, h, n, m) {
		function e(a) {
			var b = a.index;
			return a.series && a.series.data &&
				B(b) ? v(a.series.data, function (a) {
		...
		function l(a) {
			...
			return !k(a) && !b.exposeAsGroupOnly
		}

		function f(a) {
			var b = a.chart.options.accessibility.keyboardNavigation.seriesNavigation;
			return !(!a.points || !(a.points.length < b.pointNavigationEnabledThreshold ||
				!1 === b.pointNavigationEnabledThreshold))
		}

		function b(a, b) {
			var c = a.series.chart,
				d = c.options.accessibility.point || {};
			a = a.series.tooltipOptions || {};
			c = c.options.lang;
			return x(b) ? C(b, d.valueDecimals || a.valueDecimals || -1, c.decimalPoint, c.accessibility.thousandsSep || c.thousandsSep) : b
		}
		...
		function g(b) {
			var c = b.series,
				d = c.chart,
				e = d.options.accessibility.point || {};
			if (c.xAxis && c.xAxis.isDatetimeAxis) return c = a.Tooltip.prototype.getXDateFormat.call({
				getDateFormat: a.Tooltip.prototype.getDateFormat,
				chart: d
			}, b, d.options.tooltip, c.xAxis), e = e.dateFormatter && e.dateFormatter(b) || e.dateFormat || c, d.time.dateFormat(e, b.x, void 0)
		}

		function t(a) {
			var b = g(a),
				c = (a.series.xAxis || {}).categories && B(a.category) && ("" + a.category).replace("<br/>", " "),
				d = a.id && 0 > a.id.indexOf("highcharts-"),
				e = "x, " + a.x;
			return a.name || b || c || (d ? a.id : e)
		}
		...
		function y(a) {
			var c = a.series,
				...
				e = c.tooltipOptions || {},
				g = d.valuePrefix || e.valuePrefix || "";
			d = d.valueSuffix || e.valueSuffix || "";
			e = b(a, a["undefined" !== typeof a.value ? "value" : "y"]);
			return a.isNull ? c.chart.langFormat("accessibility.series.nullPointValue", {
				point: a
			}) : c.pointArrayMap ? w(a, g, d) : g + e + d
		}
		...
		function q(a) {
			var b = a.series,
				...
				e = z(b.xAxis && b.xAxis.options.accessibility && b.xAxis.options.accessibility.enabled, !c.angular),
				g = t(a),
				v = y(a);
			return (B(a.index) ? a.index + 1 + ". " : "") + (e ? g + ", " : "") + (v + ".") + (d ? " " + d : "") + (1 < c.series.length && b.name ? " " + b.name + "." : "")
		}
		...
		function u(a) {
			...
			(b || c) && a.points.forEach(function (a) {
				var c = a.isNull,
					d;
				if (!(d = a.graphic && a.graphic.element)) {
					if (c) {
						d =
							a.series;
						var g = e(a);
						d = (c = g && g.graphic) ? c.parentGroup : d.graph || d.group;
						g = g ? {
							x: z(a.plotX, g.plotX, 0),
							y: z(a.plotY, g.plotY, 0)
						} : {
							x: z(a.plotX, 0),
							y: z(a.plotY, 0)
						};
						g = a.series.chart.renderer.rect(g.x, g.y, 1, 1);
						g.attr({
						...
						d && d.element ? (a.graphic = g, g.add(d), d.element.insertBefore(g.element, c ? c.element : null), c = g.element) : c = void 0
					}
					d = c
				}
				if (c = d) c.setAttribute("tabindex", "-1"), b ? (g = a.series, d = g.chart.options.accessibility.point || {}, g = g.options.accessibility || {}, a = p(g.pointDescriptionFormatter && g.pointDescriptionFormatter(a) || d.descriptionFormatter && d.descriptionFormatter(a) || q(a)), c.setAttribute("role", "img"), c.setAttribute("aria-label", a)) : c.setAttribute("aria-hidden", !0)
			})
		}
		...
		function A(a) {
			...
			e = 1 < e.length ?
				"Combination" : "";
			return (b.langFormat("accessibility.series.summary." + a.type + e, q) || b.langFormat("accessibility.series.summary.default" + e, q)) + (g ? " " + g : "") + (v("yAxis") ? " " + f : "") + (v("xAxis") ? " " + t : "")
		}
		var C = a.numberFormat,
			v = a.find,
			x = h.isNumber,
			z = h.pick,
			B = h.defined,
			p = n.stripHTMLTagsFromString,
			E = n.reverseChildNodes,
			F = m.getAxisDescription,
			G = m.getSeriesFirstPointElement,
			H = m.getSeriesA11yElement,
			I = m.unhideChartElementFromAT;
		return {
			describeSeries: function (a) {
				...
				if (d) {
					...
					b.options3d && b.options3d.enabled && c || !(c || e || g || k(a)) ? d.setAttribute("aria-label", "") : (b = a.chart.options.accessibility, c = b.landmarkVerbosity, (a.options.accessibility || {}).exposeAsGroupOnly ? d.setAttribute("role", "img") : "all" === c && d.setAttribute("role", "region"), d.setAttribute("tabindex", "-1"), d.setAttribute("aria-label",
						p(b.series.descriptionFormatter && b.series.descriptionFormatter(a) || A(a))))
				}
			},
			defaultPointDescriptionFormatter: q,
			defaultSeriesDescriptionFormatter: A,
			getPointA11yTimeDescription: g,
			getPointXDescription: t,
			getPointValueDescription: y
		}
	});
	p(a, "modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/components/SeriesComponent/SeriesDescriber.js"],
		a["modules/accessibility/utils/EventProvider.js"], a["modules/accessibility/utils/DOMElementProvider.js"]
	], function (a, h, n, m, e, k, r) {
		function f(a) {
		...
		var c = h.extend,
			d = h.defined,
			g = n.visuallyHideElement,
			t = m.getChartTitle,
			l = e.defaultPointDescriptionFormatter,
			y = e.defaultSeriesDescriptionFormatter;
		h = function (a) {
			this.chart = a
		};
		c(h.prototype, {
			...
			addAnnounceRegion: function () {
				var a = this.chart,
					b = this.domElementProvider.createElement("div"),
					c = a.options.accessibility.announceNewData;
				b.setAttribute("aria-hidden",
					!1);
				b.setAttribute("aria-live", c.interruptUser ? "assertive" : "polite");
				g(b);
			...
			addEventListeners: function () {
				...
				d.addEvent(a.Series, "updatedData", function () {
					b.onSeriesUpdatedData(this)
				});
				d.addEvent(c, "afterAddSeries", function (a) {
					b.onSeriesAdded(a.series)
				});
				d.addEvent(a.Series, "addPoint", function (a) {
			...
			onSeriesAdded: function (a) {
				this.chart.options.accessibility.announceNewData.enabled && (this.dirty.hasDirty = !0, this.dirty.allSeries[a.name + a.index] = a, this.dirty.newSeries = d(this.dirty.newSeries) ? void 0 : a)
			},
			onPointAdded: function (a) {
				var b = a.series.chart;
				this.chart === b && b.options.accessibility.announceNewData.enabled &&
			...
			queueAnnouncement: function (a, c, d) {
				...
				if (e.enabled) {
					var g = this,
						t = +new Date;
					e = Math.max(0,
						e.minAnnounceInterval - (t - this.lastAnnouncementTime));
					a = b(this.queuedAnnouncement && this.queuedAnnouncement.series, a);
					if (c = this.buildAnnouncementMessage(a, c, d)) this.queuedAnnouncement && clearTimeout(this.queuedAnnouncementTimer), this.queuedAnnouncement = {
						time: t,
						message: c,
						series: a
					}, g.queuedAnnouncementTimer = setTimeout(function () {
						g && g.announceRegion && (g.lastAnnouncementTime = +new Date, g.liveRegionSpeak(g.queuedAnnouncement.message), delete g.queuedAnnouncement, delete g.queuedAnnouncementTimer)
					}, e)
				}
			},
			liveRegionSpeak: function (a) {
				...
				this.clearAnnouncementContainerTimer && clearTimeout(this.clearAnnouncementContainerTimer);
				this.clearAnnouncementContainerTimer = setTimeout(function () {
					b.announceRegion.innerHTML = "";
					delete b.clearAnnouncementContainerTimer
				}, 1E3)
			},
			buildAnnouncementMessage: function (b, c, d) {
				var e = this.chart,
					g = e.options.accessibility.announceNewData;
				if (g.announcementFormatter && (b = g.announcementFormatter(b, c, d), !1 !== b)) return b.length ? b : null;
				b = a.charts && 1 < a.charts.length ? "Multiple" : "Single";
				b = c ? "newSeriesAnnounce" + b : d ? "newPointAnnounce" + b : "newDataAnnounce";
				g = t(e);
				return e.langFormat("accessibility.announceNewData." + b, {
					chartTitle: g,
					seriesDesc: c ? y(c) : null,
					pointDesc: d ? l(d) : null,
					point: d,
					series: c
				})
			}
	...
	p(a, "modules/accessibility/components/SeriesComponent/forcedMarkers.js", [a["parts/Globals.js"]], function (a) {
		...
		return function () {
			a.addEvent(a.Series, "render", function () {
				var a = this.options,
					e = this.chart.options.accessibility.enabled,
					k = !1 !== (this.options.accessibility && this.options.accessibility.enabled);
				var r = this.chart.options.accessibility;
				r = this.points.length < r.series.pointDescriptionEnabledThreshold || !1 === r.series.pointDescriptionEnabledThreshold;
				var f = this.chart.options.accessibility.keyboardNavigation.seriesNavigation;
				f = this.points.length < f.pointNavigationEnabledThreshold || !1 === f.pointNavigationEnabledThreshold;
				if (e && k && (r || f)) {
					if (a.marker && !1 === a.marker.enabled && (this.a11yMarkersForced = !0, h(this.options)), this._hasPointMarkers &&
						...
						for (a = this.points, e = a.length; e--;) k = a[e].options, k.marker && (k.marker.enabled ? l(!0, k.marker, {
							states: {
								normal: {
									opacity: k.marker.states && k.marker.states.normal && k.marker.states.normal.opacity || 1
								}
							}
						}) : h(k))
				} else this.a11yMarkersForced && this.resetMarkerOptions && (delete this.a11yMarkersForced, a = this.resetA11yMarkerOptions, l(!0, this.options, {
					marker: {
						enabled: a.enabled,
						states: {
							normal: {
	...
	p(a, "modules/accessibility/components/SeriesComponent/SeriesComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js"], a["modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js"], a["modules/accessibility/components/SeriesComponent/forcedMarkers.js"], a["modules/accessibility/utils/chartUtilities.js"],
		a["modules/accessibility/components/SeriesComponent/SeriesDescriber.js"]
	], function (a, h, n, m, e, k, r, f) {
		h = h.extend;
		var b = r.hideSeriesFromAT,
			c = f.describeSeries;
		a.SeriesAccessibilityDescriber = f;
		k();
		k = function () {};
		k.prototype = new n;
		h(k.prototype, {
			init: function () {
				this.newDataAnnouncer = new e(this.chart);
				this.newDataAnnouncer.init();
				this.keyboardNavigation = new m(this.chart, this.keyCodes);
			...
			hideTooltipFromATWhenShown: function () {
				var b =
					this;
				this.addEvent(a.Tooltip, "refresh", function () {
			...
			onChartRender: function () {
				this.chart.series.forEach(function (a) {
					!1 !== (a.options.accessibility && a.options.accessibility.enabled) && a.visible ? c(a) : b(a)
				})
			},
			getKeyboardNavigation: function () {
	...
	p(a, "modules/accessibility/components/ZoomComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]],
		function (a, h, n, m, e, k) {
			var l = h.extend,
				f = h.pick,
				b = e.unhideChartElementFromAT,
				c = k.setElAttrs,
				d = k.removeElement;
			a.Axis.prototype.panStep = function (a, b) {
				var c = b || 3;
				b = this.getExtremes();
				var d = (b.max - b.min) / c * a;
				c = b.max + d;
				d = b.min + d;
				var e = c - d;
				0 > a && d < b.dataMin ? (d = b.dataMin, c = d + e) : 0 < a && c > b.dataMax && (c = b.dataMax, d = c - e);
			...
			l(a.prototype, {
				...
				onChartUpdate: function () {
					var a = this.chart,
						c = this;
					a.mapNavButtons && a.mapNavButtons.forEach(function (d, e) {
						b(a, d.element);
						c.setMapNavButtonAttrs(d.element, "accessibility.zoom.mapZoom" + (e ? "Out" : "In"))
					})
				},
				setMapNavButtonAttrs: function (a, b) {
					var d = this.chart;
					b = d.langFormat(b, {
						chart: d
					});
				...
				updateProxyOverlays: function () {
					...
					a.resetZoomButton && this.recreateProxyButtonAndGroup(a.resetZoomButton, "resetZoomProxyButton", "resetZoomProxyGroup", a.langFormat("accessibility.zoom.resetZoomButton", {
						chart: a
					}));
					a.drillUpButton && this.recreateProxyButtonAndGroup(a.drillUpButton, "drillUpProxyButton", "drillUpProxyGroup", a.langFormat("accessibility.drillUpButton", {
						chart: a,
				...
				recreateProxyButtonAndGroup: function (a, b, c, e) {
					...
					this[b] = this.createProxyButton(a, this[c], {
						"aria-label": e,
						tabindex: -1
					})
				},
				getMapZoomNavigation: function () {
					...
					return new m(b, {
						...
						validate: function () {
							return !!(b.mapZoom && b.mapNavButtons && b.mapNavButtons.length)
						},
						init: function (a) {
				...
				onMapKbdArrow: function (a, b) {
					var c = this.keyCodes;
					this.chart[b ===
						c.up || b === c.down ? "yAxis" : "xAxis"][0].panStep(b === c.left || b === c.up ? -1 : 1);
					return a.response.success
				},
				onMapKbdTab: function (a, b) {
					var c = this.chart;
					a = a.response;
					...
					if (d) return c.mapZoom(), a[b ? "prev" : "next"];
					this.focusedMapNavButtonIx += b ? -1 : 1;
					b = c.mapNavButtons[this.focusedMapNavButtonIx];
				...
				simpleButtonNavigation: function (a, b, c) {
					var d = this.keyCodes,
						e = this,
						g = this.chart;
					return new m(g, {
						...
						validate: function () {
							return g[a] && g[a].box && e[b]
						},
						init: function () {
							g.setFocusToElement(g[a].box, e[b])
						}
					})
				},
				getKeyboardNavigation: function () {
	...
	p(a, "modules/accessibility/components/RangeSelectorComponent.js", [a["parts/Globals.js"],
		a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]
	], function (a, h, n, m, e, k) {
		h = h.extend;
		var r = e.unhideChartElementFromAT,
			f = k.setElAttrs;
		a.Chart.prototype.highlightRangeSelectorButton = function (a) {
			var b = this.rangeSelector.buttons,
				d = this.highlightedRangeSelectorItemIx;
			"undefined" !== typeof d && b[d] && b[d].setState(this.oldRangeSelectorItemState ||
				0);
			this.highlightedRangeSelectorItemIx = a;
			return b[a] ? (this.setFocusToElement(b[a].box, b[a].element), this.oldRangeSelectorItemState = b[a].state, b[a].setState(2), !0) : !1
		};
		a = function () {};
		a.prototype = new n;
		h(a.prototype, {
			...
			setRangeButtonAttrs: function (a) {
				var b = this.chart;
				b = b.langFormat("accessibility.rangeSelector.buttonText", {
					chart: b,
			...
			setRangeInputAttrs: function (a, c) {
				var b = this.chart;
				f(a, {
					tabindex: -1,
					role: "textbox",
			...
			getRangeSelectorButtonNavigation: function () {
				...
				return new m(a, {
					...
					init: function (b) {
						var c = a.rangeSelector.buttons.length - 1;
			...
			onButtonNavKbdArrowKey: function (a, c) {
				var b = a.response,
					e = this.keyCodes,
					f = this.chart,
					k = f.options.accessibility.keyboardNavigation.wrapAround;
				c = c === e.left || c === e.up ? -1 : 1;
				return f.highlightRangeSelectorButton(f.highlightedRangeSelectorItemIx +
				...
				return new m(a, {
					keyCodeMap: [
						[
							[c.tab, c.up, c.down],
							function (a, b) {
								return d.onInputKbdMove(this, a === c.tab && b.shiftKey || a === c.up ? -1 : 1)
							}
						]
					],
					validate: function () {
			...
			onInputKbdMove: function (a, c) {
				var b = this.chart;
				a = a.response;
				var e = b.highlightedInputRangeIx += c;
				if (1 < e || 0 > e) return a[0 < c ? "next" : "prev"];
			...
			onInputNavInit: function (a) {
				var b =
					this.chart;
				a = 0 < a ? 0 : 1;
				b.highlightedInputRangeIx = a;
				b.rangeSelector[a ? "maxInput" : "minInput"].focus()
			},
	...
	p(a, "modules/accessibility/components/InfoRegionsComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"],
		a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]
	], function (a, h, n, m, e) {
		function k(a) {
			return a.replace(/&lt;(h[1-7]|p|div)&gt;/g, "<$1>").replace(/&lt;&#x2F;(h[1-7]|p|div|a|button)&gt;/g, "</$1>").replace(/&lt;(div|a|button) id=&quot;([a-zA-Z\-0-9#]*?)&quot;&gt;/g, '<$1 id="$2">')
		}
		var r = a.win.document,
			f = a.format,
			b = h.extend,
			c = h.pick,
			d = m.unhideChartElementFromAT,
			g = m.getChartTitle,
			l = m.getAxisDescription,
			w = e.addClass,
			p = e.setElAttrs,
			q = e.escapeStringForHTML,
			u = e.stripHTMLTagsFromString,
			A = e.getElement,
			C = e.visuallyHideElement;
		a.Chart.prototype.getTypeDescription = function (a) {
			...
			if (!b) return this.langFormat("accessibility.chartTypes.emptyChart", c);
			...
			return (this.langFormat("accessibility.chartTypes." + a + d, c) || this.langFormat("accessibility.chartTypes.default" + d, c)) + (b ? " " + b : "")
		};
		h = function () {};
		h.prototype = new n;
		b(h.prototype, {
			init: function () {
				...
				this.addEvent(a, "afterGetTable", function (a) {
			...
			initRegionsDefinitions: function () {
				...
				this.screenReaderSections = {
					...
					after: {
						...
						buildContent: function (b) {
							var c =
								b.options.accessibility.screenReaderSection.afterChartFormatter;
			...
			setLinkedDescriptionAttrs: function () {
				...
				a && (a.setAttribute("aria-hidden", "true"), w(a, "highcharts-linked-description"))
			},
			updateScreenReaderSection: function (a) {
				var b = this.chart,
					c = this.screenReaderSections[a],
					e = c.buildContent(b),
					g = c.element = c.element || this.createElement("div"),
					f = g.firstChild || this.createElement("div");
				this.setScreenReaderSectionAttribs(g, a);
				f.innerHTML =
					e;
				g.appendChild(f);
				c.insertIntoDOM(g, b);
			...
			defaultBeforeChartFormatter: function () {
				var b = this.chart,
					...
					e = "hc-linkto-highcharts-data-table-" + b.index;
				d = {
					chartTitle: g(b),
					...
					viewTableButton: b.getCSV ? this.getDataTableButtonText(e) : ""
				};
				b = a.i18nFormat(c, d, b);
				this.dataTableButtonId = e;
				return k(q(b)).replace(/<(\w+)[^>]*?>\s*<\/\1>/g, "")
			},
			...
			onDataTableCreated: function (a) {
				var b =
					this.chart;
				b.options.accessibility.enabled && (this.viewDataTableButton && this.viewDataTableButton.setAttribute("aria-expanded", "true"), a.html = a.html.replace("<table ", '<table tabindex="0" summary="' + b.langFormat("accessibility.table.tableSummary", {
					chart: b
				}) + '"'))
			},
			...
			initDataTableButton: function (a) {
				var b = this.viewDataTableButton = A(a),
					c = this.chart;
			...
			getAxesDescription: function () {
				var a = this.chart,
					...
					g = b("xAxis", !a.angular && e && d);
				b = b("yAxis", e && d);
				d = {};
				g && (d.xAxis = this.getAxisDescriptionText("xAxis"));
			...
			getAxisDescriptionText: function (a) {
				var b = this,
					c = this.chart,
					d = c[a];
				return c.langFormat("accessibility.axis." + a + "Description" + (1 < d.length ? "Plural" : "Singular"), {
					chart: c,
			...
			getAxisRangeDescription: function (a) {
				var b = a.options || {};
				return b.accessibility && "undefined" !== typeof b.accessibility.rangeDescription ? b.accessibility.rangeDescription : a.categories ? this.getCategoryAxisRangeDesc(a) :
					!a.isDatetimeAxis || 0 !== a.min && 0 !== a.dataMin ? this.getAxisFromToDescription(a) : this.getAxisTimeLengthDesc(a)
			},
			getCategoryAxisRangeDesc: function (a) {
				var b = this.chart;
				return a.dataMax && a.dataMin ? b.langFormat("accessibility.axis.rangeCategories", {
					chart: b,
					axis: a,
			...
			getAxisTimeLengthDesc: function (a) {
				...
				return b.langFormat("accessibility.axis.timeRange" + d, {
					chart: b,
					axis: a,
					range: e.replace(".0", "")
				})
			...
			getAxisFromToDescription: function (a) {
				var b = this.chart,
					c = b.options.accessibility.screenReaderSection.axisRangeDateFormat,
					d = function (d) {
						return a.isDatetimeAxis ? b.time.dateFormat(c, a[d]) : a[d]
					};
	...
	p(a, "modules/accessibility/components/ContainerComponent.js",
		[a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/AccessibilityComponent.js"]],
		function (a, h, n, m, e) {
			var k = a.win.document;
			a = h.extend;
			var r = n.stripHTMLTagsFromString,
				f = m.unhideChartElementFromAT,
				b = m.getChartTitle;
			n = function () {};
			n.prototype = new e;
			a(n.prototype, {
				...
				handleSVGTitleElement: function () {
					var a = this.chart,
						...
						e = r(a.langFormat("accessibility.svgContainerTitle", {
							chartTitle: b(a)
						}));
					if (e.length) {
						var f = this.svgTitleElement = this.svgTitleElement || k.createElementNS("http://www.w3.org/2000/svg", "title");
						f.textContent = e;
						f.id = d;
				...
				setSVGContainerLabel: function () {
					var a = this.chart,
						d = r(a.langFormat("accessibility.svgContainerLabel", {
							chartTitle: b(a)
						}));
					a.renderer.box &&
				...
				makeCreditsAccessible: function () {
					var a = this.chart,
						b = a.credits;
					b && (b.textStr && b.element.setAttribute("aria-label", r(a.langFormat("accessibility.credits", {
						creditsStr: b.textStr
					}))), f(a, b.element))
				},
				destroy: function () {
	...
	p(a, "modules/accessibility/high-contrast-mode.js", [a["parts/Globals.js"]], function (a) {
		...
		return {
			isHighContrastModeActive: function () {
				...
				if (h && l.getComputedStyle) {
					var a = m.createElement("div");
					a.style.backgroundImage = "url(#)";
					m.body.appendChild(a);
					var k = (a.currentStyle || l.getComputedStyle(a)).backgroundImage;
			...
			setHighContrastTheme: function (a) {
				...
				var e = a.options.accessibility.highContrastTheme;
				a.update(e, !1);
				a.series.forEach(function (a) {
					var f = e.plotOptions[a.type] || {};
					a.update({
	...
	p(a, "modules/accessibility/options/options.js", [], function () {
		return {
			accessibility: {
				enabled: !0,
				screenReaderSection: {
					beforeChartFormat: "<h5>{chartTitle}</h5><div>{typeDescription}</div><div>{chartSubtitle}</div><div>{chartLongdesc}</div><div>{xAxisDescription}</div><div>{yAxisDescription}</div><div>{viewTableButton}</div>",
	...
	p(a, "modules/accessibility/options/deprecatedOptions.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, h) {
		function l(a, c, e) {
			b("Highcharts: Deprecated option " + c + " used. This will be removed from future versions of Highcharts. Use " + e + " instead.", !1, a)
		}

		function m(a, b, e) {
			for (var d, g = 0; g < b.length - 1; ++g) d = b[g], a = a[d] = c(a[d], {});
			a[b[b.length - 1]] = e
		}
		...
		function e(a, b, c,
			...
			Object.keys(e).forEach(function (d) {
				var k = g[d];
				"undefined" !== typeof k && (m(f, e[d], k), l(a, b.join(".") + "." + d, c.join(".") + "." + e[d].join(".")))
			})
		}
		...
		function k(a) {
			...
			["description", "typeDescription"].forEach(function (d) {
				b[d] && (c[d] = b[d], l(a, "chart." + d, "accessibility." + d))
			})
		}
		...
		function f(a) {
			...
			a.series.forEach(function (c) {
				Object.keys(b).forEach(function (d) {
					var e = c.options[d];
					"undefined" !== typeof e && (m(c.options,
		...
		return function (a) {
			...
			r(a);
			a.series && f(a);
			e(a, ["accessibility"], ["accessibility"], {
			...
			e(a, ["lang", "accessibility"], ["lang", "accessibility"], {
	...
	p(a, "modules/accessibility/a11y-i18n.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, h) {
		function l(a, k) {
			...
			if (-1 < e) {
				...
				a = "";
				if (k = k[b[0]])
					for (e = isNaN(e) ? k.length : e, e = 0 > e ? k.length + e : Math.min(e, k.length), b = 0; b < e; ++b) a += d + k[b] + f;
				return a.length ? a : ""
			}
			if (-1 < f) {
				d = a.slice(f).indexOf(")") + f;
				a = a.substring(f + 8, d).split(",");
				switch (Number(k[a[0]])) {
					case 0:
						a = m(a[4], a[1]);
						break;
				...
				a ? (k = a, k = k.trim && k.trim() || k.replace(/^\s+|\s+$/g, "")) : k = "";
				return k
			}
			return -1 < b ? (f = a.substring(0, b), a = Number(a.substring(b + 1, c)), k = k[f], !isNaN(a) && k && (0 >
				a ? (d = k[k.length + a], "undefined" === typeof d && (d = k[0])) : (d = k[a], "undefined" === typeof d && (d = k[k.length - 1]))), "undefined" !== typeof d ? d : "") : "{" + a + "}"
		}
		var m = h.pick;
		a.i18nFormat = function (e, k, h) {
			var f = function (a, b) {
					a = a.slice(b || 0);
					var c = a.indexOf("{"),
						d = a.indexOf("}");
			...
			do {
				var d = f(e, c);
				var g = e.substring(c, d && d.begin - 1);
				g.length && b.push({
					value: g,
					type: "constant"
				});
			...
			b.forEach(function (a) {
				"statement" === a.type && (a.value = l(a.value, k))
			});
			return a.format(b.reduce(function (a, b) {
				return a + b.value
			}, ""), k, h)
		};
		a.Chart.prototype.langFormat = function (e, k) {
			e = e.split(".");
			for (var h = this.options.lang, f = 0; f < e.length; ++f) h = h && h[e[f]];
			return "string" === typeof h ? a.i18nFormat(h, k, this) : ""
		}
	});
	p(a, "modules/accessibility/focusBorder.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, h) {
		...
		m(a.SVGElement.prototype, {
			addFocusBorder: function (a,
				...
				var f = this.getBBox();
				a = e(a, 3);
				f.x += this.translateX ? this.translateX : 0;
				f.y += this.translateY ? this.translateY : 0;
				this.focusBorder = this.renderer.rect(f.x - a, f.y - a, f.width + 2 * a, f.height + 2 * a, parseInt((h && h.borderRadius || 0).toString(), 10)).addClass("highcharts-focus-border").attr({
					zIndex: 99
				}).add(this.parentGroup);
				this.renderer.styledMode || this.focusBorder.attr({
					stroke: h && h.stroke,
					"stroke-width": h && h.strokeWidth
				})
			},
		...
		a.Chart.prototype.setFocusToElement = function (a, e) {
			var f = this.options.accessibility.keyboardNavigation.focusBorder;
			(e = e || a.element) && e.focus && (e.hcEvents && e.hcEvents.focusin || l(e, "focusin", function () {}), e.focus(), f.hideBrowserFocusOutline && (e.style.outline = "none"));
			f.enabled && (this.focusElement && this.focusElement.removeFocusBorder(), a.addFocusBorder(f.margin, {
					stroke: f.style.color,
					strokeWidth: f.style.lineWidth,
	...
	p(a, "modules/accessibility/accessibility.js", [a["modules/accessibility/utils/chartUtilities.js"], a["parts/Globals.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigation.js"], a["modules/accessibility/components/LegendComponent.js"], a["modules/accessibility/components/MenuComponent.js"], a["modules/accessibility/components/SeriesComponent/SeriesComponent.js"],
		a["modules/accessibility/components/ZoomComponent.js"], a["modules/accessibility/components/RangeSelectorComponent.js"], a["modules/accessibility/components/InfoRegionsComponent.js"], a["modules/accessibility/components/ContainerComponent.js"], a["modules/accessibility/high-contrast-mode.js"], a["modules/accessibility/high-contrast-theme.js"], a["modules/accessibility/options/options.js"], a["modules/accessibility/options/langOptions.js"], a["modules/accessibility/options/deprecatedOptions.js"]
	], function (a,
		...
		h.KeyboardNavigationHandler = n;
		h.AccessibilityComponent = e;
		l.prototype = {
			init: function (a) {
				this.chart = a;
				z.addEventListener && a.renderer.isSVG ? (A(a), this.initComponents(), this.keyboardNavigation = new k(a, this.components), this.update()) : a.renderTo.setAttribute("aria-hidden", !0)
			},
			initComponents: function () {
				var a =
					this.chart,
					e = a.options.accessibility;
				this.components = {
					container: new t,
					infoRegions: new g,
					legend: new p,
				...
				e.customComponents && r(this.components, e.customComponents);
			...
			update: function () {
				...
				!b.highContrastModeActive && w.isHighContrastModeActive() && w.setHighContrastTheme(b);
				D(b, "afterA11yUpdate")
			},
			destroy: function () {
				var a = this.chart || {},
		...
		h.Chart.prototype.updateA11yEnabled = function () {
			...
			b && b.enabled ? a ? a.update() : this.accessibility = new l(this) : a ? (a.destroy && a.destroy(), delete this.accessibility) : this.renderTo.setAttribute("aria-hidden", !0)
		};
		x(h.Chart, "render", function (a) {
			this.a11yDirty && this.renderTo && (delete this.a11yDirty, this.updateA11yEnabled());
			var b = this.accessibility;
			b && Object.keys(b.components).forEach(function (a) {
				b.components[a].onChartRender()
			})
		});
		x(h.Chart, "update", function (a) {
			if (a = a.options.accessibility) a.customComponents && (this.options.accessibility.customComponents = a.customComponents, delete a.customComponents), B(!0, this.options.accessibility, a), this.accessibility && this.accessibility.destroy && (this.accessibility.destroy(), delete this.accessibility);
			this.a11yDirty = !0
		});
		x(h.Point, "update", function () {
			this.series.chart.accessibility && (this.series.chart.a11yDirty = !0)
		});
		["addSeries", "init"].forEach(function (a) {
			x(h.Chart, a, function () {
				this.a11yDirty = !0
			})
		});
		["update", "updatedData", "remove"].forEach(function (a) {
			x(h.Series, a, function () {
