	...
	q(c, "mixins/download-url.js", [c["parts/Globals.js"]], function (b) {
		...
		b.downloadURL = function (e, h) {
			...
			if ("string" === typeof e || e instanceof String || !c.msSaveOrOpenBlob) {
				...
				if ("undefined" !== typeof p.download) p.href = e, p.download = h, q.body.appendChild(p), p.click(), q.body.removeChild(p);
				else try {
					var d = a.open(e, "chart");
					if ("undefined" === typeof d || null === d) throw Error("Failed to open window");
				} catch (A) {
					a.location.href = e
				}
		...
		b.Chart.prototype.getTable = function (a) {
			...
			b += function (a, b, e) {
				...
				if (b) {
					d += "<tr>";
					f = 0;
					for (e = b.length; f < e; ++f) "undefined" !== typeof b[f] && (d += n("th", null, 'scope="col"', b[f]));
					d += "</tr>"
				}
				return d + "</thead>"
