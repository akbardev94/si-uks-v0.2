...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item user"><a href="<?= base_url('admin'); ?>"><i class="fas fa-home"></i> Admin</a></li>
            <li class="breadcrumb-item active user2"><a href="<?= base_url('admin/rapor'); ?>" aria-current="page">Rapor Kesehatan</a></li>
        </ol>
    </nav>
    ...
    <div class="container-fluid">
        ...
        <form action="<?= base_url('admin/rapor') ?>" method="post">
            <div class="form-group">
                <select name="noinduk" id="noinduk" class="js-example-basic-single" style="width: 100%">
                    <option value="">- Pilih Siswa -</option>
                    <?php foreach ($siswa as $s) { ?>
                        <option value="<?= $s['noinduk'] ?>" <?php if ($nis == $s['noinduk']) {
                                                                    echo "selected";
                                                                } ?>><?= $s['nama'] ?></option>
                    <?php } ?>
                </select>
            </div>
            <button type="submit" class="btn btn-primary mb-3 ml-2 export">Tampil</button>
                        ...
                        <div class="box-body">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <th colspan="6" class="h5"><i class='fas fa-user'> &nbsp;Identitas Siswa :</i></th>
                                    </tr>
                                    <tr>
                                        <th>&nbsp;</th>
                                    </tr>
